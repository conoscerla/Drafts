...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    if (balance < 0) {
      alert(`Ви використали усі свої кошти. Поповніть картку`);
      // setBalance(0);
    }
  ...
  const safeMoney = () => {
    setBalance(balance - SAFE_MONEY);

    setPayment([
      {
        name: `Покладено в сейф`,
        amount: SAFE_MONEY,
        type: "*"
      },
      ...payment
  ...
  return (
    <Page>
      ...
      */}
      ...
      <Header name="Dessert BANK" onClick={doLogin} />
          ...
          config={[
            {
              ...
              onClick: getMoney,
              img: "/icon/savings-svgrepo-com.svg"
            },
            {
              name: "Отримати зарплату",
              onClick: getSalary,
              img: "/icon/reward-svgrepo-com.svg"
            },
            {
              name: "Сплатити за курс",
              onClick: buyCourse,
              img: "/icon/money-svgrepo-com.svg"
            },
            {
              name: "Зберегти кошти",
              onClick: safeMoney,
              img: "/icon/savings-save-svgrepo-com.svg"
            }
          ]}
        />
      )}
